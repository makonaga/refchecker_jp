...
LLM_CHECKING_PROMPT_Q = """質問に対する言語モデルの主張について、提供された参照文献に基づいて妥当性を検証してください。
主張は（主語、述語、目的語）の三つ組形式で表現されています。
...
回答は次の単語のみで答えてください: ['Entailment', 'Neutral', 'Contradiction']
"""
...
LLM_CHECKING_PROMPT = """言語モデルが生成した主張について、提供された参照文献に基づいて妥当性を検証してください。
...
SUBSENTENCE_CLAIM_CHECKING_PROMPT = """言語モデルが生成した主張について、提供された参照文献に基づいて妥当性を検証してください。
